...
```{r}
norm_data <- preprocessCore::normalize.quantiles(as.matrix(expr_data))
```
...
- Triplicates witin the CMS cluster should be closer togher.

</details>

We will do a PCA and plot the socres of each sample and color them by CMS.
...
-  Why are not the different CMS subtypes clustered together even after normalization and batch correction?
